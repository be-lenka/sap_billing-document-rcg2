...
namespace BeLenka\SAP\BillingDocumentRCG2;
...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://:/sap/opu/odata/sap/API_BILLING_DOCUMENT_SRV';
    ...
    {
        $report  = 'PHP SDK (BeLenka\SAP\BillingDocumentRCG2) Debug Report:' . PHP_EOL;
