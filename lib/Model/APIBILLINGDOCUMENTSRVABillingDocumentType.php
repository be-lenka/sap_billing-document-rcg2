...
/**
 * APIBILLINGDOCUMENTSRVABillingDocumentType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BillingDocumentRCG2
 * @author   OpenAPI Generator team
 ...
 */
class APIBILLINGDOCUMENTSRVABillingDocumentType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BILLING_DOCUMENT_SRV.A_BillingDocumentType';
    ...
    protected static $openAPITypes = [
        ...
        'to_item' => '\BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToItem',
        'to_partner' => '\BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPartner',
        'to_pricing_element' => '\BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPricingElement',
        'to_text' => '\BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToText'
    ];
    ...
    */
    ...
    public function setBillingDocument($billing_document)
    {
        ...
        if ((mb_strlen($billing_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_document when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setSdDocumentCategory($sd_document_category)
    {
        ...
        if (!is_null($sd_document_category) && (mb_strlen($sd_document_category) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sd_document_category when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setBillingDocumentCategory($billing_document_category)
    {
        ...
        if (!is_null($billing_document_category) && (mb_strlen($billing_document_category) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_document_category when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingDocumentType($billing_document_type)
    {
        ...
        if (!is_null($billing_document_type) && (mb_strlen($billing_document_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $billing_document_type when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setLogicalSystem($logical_system)
    {
        ...
        if (!is_null($logical_system) && (mb_strlen($logical_system) > 10)) {
            throw new \InvalidArgumentException('invalid length for $logical_system when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesOrganization($sales_organization)
    {
        ...
        if (!is_null($sales_organization) && (mb_strlen($sales_organization) > 4)) {
            throw new \InvalidArgumentException('invalid length for $sales_organization when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setDistributionChannel($distribution_channel)
    {
        ...
        if (!is_null($distribution_channel) && (mb_strlen($distribution_channel) > 2)) {
            throw new \InvalidArgumentException('invalid length for $distribution_channel when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setDivision($division)
    {
        ...
        if (!is_null($division) && (mb_strlen($division) > 2)) {
            throw new \InvalidArgumentException('invalid length for $division when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setCancelledBillingDocument($cancelled_billing_document)
    {
        ...
        if (!is_null($cancelled_billing_document) && (mb_strlen($cancelled_billing_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $cancelled_billing_document when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setForeignTrade($foreign_trade)
    {
        ...
        if (!is_null($foreign_trade) && (mb_strlen($foreign_trade) > 10)) {
            throw new \InvalidArgumentException('invalid length for $foreign_trade when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setIsExportDelivery($is_export_delivery)
    {
        ...
        if (!is_null($is_export_delivery) && (mb_strlen($is_export_delivery) > 1)) {
            throw new \InvalidArgumentException('invalid length for $is_export_delivery when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingDocCombinationCriteria($billing_doc_combination_criteria)
    {
        ...
        if (!is_null($billing_doc_combination_criteria) && (mb_strlen($billing_doc_combination_criteria) > 40)) {
            throw new \InvalidArgumentException('invalid length for $billing_doc_combination_criteria when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 40.');
        }
    ...
    public function setTransactionCurrency($transaction_currency)
    {
        ...
        if (!is_null($transaction_currency) && (mb_strlen($transaction_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $transaction_currency when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 5.');
        }
    ...
    public function setStatisticsCurrency($statistics_currency)
    {
        ...
        if (!is_null($statistics_currency) && (mb_strlen($statistics_currency) > 5)) {
            throw new \InvalidArgumentException('invalid length for $statistics_currency when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 5.');
        }
    ...
    public function setCustomerPriceGroup($customer_price_group)
    {
        ...
        if (!is_null($customer_price_group) && (mb_strlen($customer_price_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_price_group when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setPriceListType($price_list_type)
    {
        ...
        if (!is_null($price_list_type) && (mb_strlen($price_list_type) > 2)) {
            throw new \InvalidArgumentException('invalid length for $price_list_type when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setTaxDepartureCountry($tax_departure_country)
    {
        ...
        if (!is_null($tax_departure_country) && (mb_strlen($tax_departure_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $tax_departure_country when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setVatRegistration($vat_registration)
    {
        ...
        if (!is_null($vat_registration) && (mb_strlen($vat_registration) > 20)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 20.');
        }
    ...
    public function setVatRegistrationOrigin($vat_registration_origin)
    {
        ...
        if (!is_null($vat_registration_origin) && (mb_strlen($vat_registration_origin) > 1)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_origin when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setVatRegistrationCountry($vat_registration_country)
    {
        ...
        if (!is_null($vat_registration_country) && (mb_strlen($vat_registration_country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $vat_registration_country when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setHierarchyTypePricing($hierarchy_type_pricing)
    {
        ...
        if (!is_null($hierarchy_type_pricing) && (mb_strlen($hierarchy_type_pricing) > 1)) {
            throw new \InvalidArgumentException('invalid length for $hierarchy_type_pricing when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification1($customer_tax_classification1)
    {
        ...
        if (!is_null($customer_tax_classification1) && (mb_strlen($customer_tax_classification1) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification1 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification2($customer_tax_classification2)
    {
        ...
        if (!is_null($customer_tax_classification2) && (mb_strlen($customer_tax_classification2) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification2 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification3($customer_tax_classification3)
    {
        ...
        if (!is_null($customer_tax_classification3) && (mb_strlen($customer_tax_classification3) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification3 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification4($customer_tax_classification4)
    {
        ...
        if (!is_null($customer_tax_classification4) && (mb_strlen($customer_tax_classification4) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification4 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification5($customer_tax_classification5)
    {
        ...
        if (!is_null($customer_tax_classification5) && (mb_strlen($customer_tax_classification5) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification5 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification6($customer_tax_classification6)
    {
        ...
        if (!is_null($customer_tax_classification6) && (mb_strlen($customer_tax_classification6) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification6 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification7($customer_tax_classification7)
    {
        ...
        if (!is_null($customer_tax_classification7) && (mb_strlen($customer_tax_classification7) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification7 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification8($customer_tax_classification8)
    {
        ...
        if (!is_null($customer_tax_classification8) && (mb_strlen($customer_tax_classification8) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification8 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setCustomerTaxClassification9($customer_tax_classification9)
    {
        ...
        if (!is_null($customer_tax_classification9) && (mb_strlen($customer_tax_classification9) > 1)) {
            throw new \InvalidArgumentException('invalid length for $customer_tax_classification9 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setSdPricingProcedure($sd_pricing_procedure)
    {
        ...
        if (!is_null($sd_pricing_procedure) && (mb_strlen($sd_pricing_procedure) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sd_pricing_procedure when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 6.');
        }
    ...
    public function setShippingCondition($shipping_condition)
    {
        ...
        if (!is_null($shipping_condition) && (mb_strlen($shipping_condition) > 2)) {
            throw new \InvalidArgumentException('invalid length for $shipping_condition when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setIncotermsVersion($incoterms_version)
    {
        ...
        if (!is_null($incoterms_version) && (mb_strlen($incoterms_version) > 4)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_version when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setIncotermsClassification($incoterms_classification)
    {
        ...
        if (!is_null($incoterms_classification) && (mb_strlen($incoterms_classification) > 3)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_classification when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setIncotermsTransferLocation($incoterms_transfer_location)
    {
        ...
        if (!is_null($incoterms_transfer_location) && (mb_strlen($incoterms_transfer_location) > 28)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_transfer_location when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 28.');
        }
    ...
    public function setIncotermsLocation1($incoterms_location1)
    {
        ...
        if (!is_null($incoterms_location1) && (mb_strlen($incoterms_location1) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location1 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 70.');
        }
    ...
    public function setIncotermsLocation2($incoterms_location2)
    {
        ...
        if (!is_null($incoterms_location2) && (mb_strlen($incoterms_location2) > 70)) {
            throw new \InvalidArgumentException('invalid length for $incoterms_location2 when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 70.');
        }
    ...
    public function setPayerParty($payer_party)
    {
        ...
        if (!is_null($payer_party) && (mb_strlen($payer_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $payer_party when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setContractAccount($contract_account)
    {
        ...
        if (!is_null($contract_account) && (mb_strlen($contract_account) > 12)) {
            throw new \InvalidArgumentException('invalid length for $contract_account when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 12.');
        }
    ...
    public function setCustomerPaymentTerms($customer_payment_terms)
    {
        ...
        if (!is_null($customer_payment_terms) && (mb_strlen($customer_payment_terms) > 4)) {
            throw new \InvalidArgumentException('invalid length for $customer_payment_terms when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setPaymentMethod($payment_method)
    {
        ...
        if (!is_null($payment_method) && (mb_strlen($payment_method) > 1)) {
            throw new \InvalidArgumentException('invalid length for $payment_method when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setPaymentReference($payment_reference)
    {
        ...
        if (!is_null($payment_reference) && (mb_strlen($payment_reference) > 30)) {
            throw new \InvalidArgumentException('invalid length for $payment_reference when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 30.');
        }
    ...
    public function setAdditionalValueDays($additional_value_days)
    {
        ...
        if (!is_null($additional_value_days) && (mb_strlen($additional_value_days) > 2)) {
            throw new \InvalidArgumentException('invalid length for $additional_value_days when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setSepaMandate($sepa_mandate)
    {
        ...
        if (!is_null($sepa_mandate) && (mb_strlen($sepa_mandate) > 35)) {
            throw new \InvalidArgumentException('invalid length for $sepa_mandate when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 35.');
        }
    ...
    public function setCompanyCode($company_code)
    {
        ...
        if (!is_null($company_code) && (mb_strlen($company_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $company_code when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setFiscalYear($fiscal_year)
    {
        ...
        if (!is_null($fiscal_year) && (mb_strlen($fiscal_year) > 4)) {
            throw new \InvalidArgumentException('invalid length for $fiscal_year when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setAccountingDocument($accounting_document)
    {
        ...
        if (!is_null($accounting_document) && (mb_strlen($accounting_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $accounting_document when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setCustomerAccountAssignmentGroup($customer_account_assignment_group)
    {
        ...
        if (!is_null($customer_account_assignment_group) && (mb_strlen($customer_account_assignment_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_account_assignment_group when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setExchangeRateType($exchange_rate_type)
    {
        ...
        if (!is_null($exchange_rate_type) && (mb_strlen($exchange_rate_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $exchange_rate_type when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setDocumentReferenceId($document_reference_id)
    {
        ...
        if (!is_null($document_reference_id) && (mb_strlen($document_reference_id) > 16)) {
            throw new \InvalidArgumentException('invalid length for $document_reference_id when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 16.');
        }
    ...
    public function setAssignmentReference($assignment_reference)
    {
        ...
        if (!is_null($assignment_reference) && (mb_strlen($assignment_reference) > 18)) {
            throw new \InvalidArgumentException('invalid length for $assignment_reference when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 18.');
        }
    ...
    public function setDunningArea($dunning_area)
    {
        ...
        if (!is_null($dunning_area) && (mb_strlen($dunning_area) > 2)) {
            throw new \InvalidArgumentException('invalid length for $dunning_area when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setDunningBlockingReason($dunning_blocking_reason)
    {
        ...
        if (!is_null($dunning_blocking_reason) && (mb_strlen($dunning_blocking_reason) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dunning_blocking_reason when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setDunningKey($dunning_key)
    {
        ...
        if (!is_null($dunning_key) && (mb_strlen($dunning_key) > 1)) {
            throw new \InvalidArgumentException('invalid length for $dunning_key when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setInternalFinancialDocument($internal_financial_document)
    {
        ...
        if (!is_null($internal_financial_document) && (mb_strlen($internal_financial_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $internal_financial_document when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setSoldToParty($sold_to_party)
    {
        ...
        if (!is_null($sold_to_party) && (mb_strlen($sold_to_party) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sold_to_party when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setPartnerCompany($partner_company)
    {
        ...
        if (!is_null($partner_company) && (mb_strlen($partner_company) > 6)) {
            throw new \InvalidArgumentException('invalid length for $partner_company when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 6.');
        }
    ...
    public function setPurchaseOrderByCustomer($purchase_order_by_customer)
    {
        ...
        if (!is_null($purchase_order_by_customer) && (mb_strlen($purchase_order_by_customer) > 35)) {
            throw new \InvalidArgumentException('invalid length for $purchase_order_by_customer when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 35.');
        }
    ...
    public function setCustomerGroup($customer_group)
    {
        ...
        if (!is_null($customer_group) && (mb_strlen($customer_group) > 2)) {
            throw new \InvalidArgumentException('invalid length for $customer_group when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 2.');
        }
    ...
    public function setCountry($country)
    {
        ...
        if (!is_null($country) && (mb_strlen($country) > 3)) {
            throw new \InvalidArgumentException('invalid length for $country when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setCityCode($city_code)
    {
        ...
        if (!is_null($city_code) && (mb_strlen($city_code) > 4)) {
            throw new \InvalidArgumentException('invalid length for $city_code when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setSalesDistrict($sales_district)
    {
        ...
        if (!is_null($sales_district) && (mb_strlen($sales_district) > 6)) {
            throw new \InvalidArgumentException('invalid length for $sales_district when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 6.');
        }
    ...
    public function setRegion($region)
    {
        ...
        if (!is_null($region) && (mb_strlen($region) > 3)) {
            throw new \InvalidArgumentException('invalid length for $region when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setCounty($county)
    {
        ...
        if (!is_null($county) && (mb_strlen($county) > 3)) {
            throw new \InvalidArgumentException('invalid length for $county when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 3.');
        }
    ...
    public function setCreditControlArea($credit_control_area)
    {
        ...
        if (!is_null($credit_control_area) && (mb_strlen($credit_control_area) > 4)) {
            throw new \InvalidArgumentException('invalid length for $credit_control_area when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
    ...
    public function setCustomerRebateAgreement($customer_rebate_agreement)
    {
        ...
        if (!is_null($customer_rebate_agreement) && (mb_strlen($customer_rebate_agreement) > 10)) {
            throw new \InvalidArgumentException('invalid length for $customer_rebate_agreement when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setSalesDocumentCondition($sales_document_condition)
    {
        ...
        if (!is_null($sales_document_condition) && (mb_strlen($sales_document_condition) > 10)) {
            throw new \InvalidArgumentException('invalid length for $sales_document_condition when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 10.');
        }
    ...
    public function setOverallSdProcessStatus($overall_sd_process_status)
    {
        ...
        if (!is_null($overall_sd_process_status) && (mb_strlen($overall_sd_process_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_sd_process_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallBillingStatus($overall_billing_status)
    {
        ...
        if (!is_null($overall_billing_status) && (mb_strlen($overall_billing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_billing_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setAccountingPostingStatus($accounting_posting_status)
    {
        ...
        if (!is_null($accounting_posting_status) && (mb_strlen($accounting_posting_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $accounting_posting_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setAccountingTransferStatus($accounting_transfer_status)
    {
        ...
        if (!is_null($accounting_transfer_status) && (mb_strlen($accounting_transfer_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $accounting_transfer_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingIssueType($billing_issue_type)
    {
        ...
        if (!is_null($billing_issue_type) && (mb_strlen($billing_issue_type) > 1)) {
            throw new \InvalidArgumentException('invalid length for $billing_issue_type when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setInvoiceListStatus($invoice_list_status)
    {
        ...
        if (!is_null($invoice_list_status) && (mb_strlen($invoice_list_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_list_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setOvrlItmGeneralIncompletionSts($ovrl_itm_general_incompletion_sts)
    {
        ...
        if (!is_null($ovrl_itm_general_incompletion_sts) && (mb_strlen($ovrl_itm_general_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $ovrl_itm_general_incompletion_sts when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setOverallPricingIncompletionSts($overall_pricing_incompletion_sts)
    {
        ...
        if (!is_null($overall_pricing_incompletion_sts) && (mb_strlen($overall_pricing_incompletion_sts) > 1)) {
            throw new \InvalidArgumentException('invalid length for $overall_pricing_incompletion_sts when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setInvoiceClearingStatus($invoice_clearing_status)
    {
        ...
        if (!is_null($invoice_clearing_status) && (mb_strlen($invoice_clearing_status) > 1)) {
            throw new \InvalidArgumentException('invalid length for $invoice_clearing_status when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 1.');
        }
    ...
    public function setBillingDocumentListType($billing_document_list_type)
    {
        ...
        if (!is_null($billing_document_list_type) && (mb_strlen($billing_document_list_type) > 4)) {
            throw new \InvalidArgumentException('invalid length for $billing_document_list_type when calling APIBILLINGDOCUMENTSRVABillingDocumentType., must be smaller than or equal to 4.');
        }
     ...
     * Gets to_item
     *
     * @return \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToItem|null
     */
     ...
     * Sets to_item
     *
     * @param \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToItem|null $to_item to_item
     *
     * @return self
     */
     ...
     * Gets to_partner
     *
     * @return \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPartner|null
     */
     ...
     * Sets to_partner
     *
     * @param \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPartner|null $to_partner to_partner
     *
     * @return self
     */
     ...
     *
     * @return \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPricingElement|null
     */
     ...
     *
     * @param \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToPricingElement|null $to_pricing_element to_pricing_element
     *
     * @return self
     */
     ...
     * Gets to_text
     *
     * @return \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToText|null
     */
     ...
     * Sets to_text
     *
     * @param \BeLenka\SAP\BillingDocumentRCG2\Model\APIBILLINGDOCUMENTSRVABillingDocumentTypeToText|null $to_text to_text
     *
     * @return self
     */
