...
/**
 * APIBILLINGDOCUMENTSRVABillingDocumentItemTextType Class Doc Comment
 *
 * @category Class
 * @package  BeLenka\SAP\BillingDocumentRCG2
 * @author   OpenAPI Generator team
 ...
 */
class APIBILLINGDOCUMENTSRVABillingDocumentItemTextType implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $openAPIModelName = 'API_BILLING_DOCUMENT_SRV.A_BillingDocumentItemTextType';
    ...
    */
    ...
    public function setBillingDocument($billing_document)
    {
        ...
        if ((mb_strlen($billing_document) > 10)) {
            throw new \InvalidArgumentException('invalid length for $billing_document when calling APIBILLINGDOCUMENTSRVABillingDocumentItemTextType., must be smaller than or equal to 10.');
        }
    ...
    public function setBillingDocumentItem($billing_document_item)
    {
        ...
        if ((mb_strlen($billing_document_item) > 6)) {
            throw new \InvalidArgumentException('invalid length for $billing_document_item when calling APIBILLINGDOCUMENTSRVABillingDocumentItemTextType., must be smaller than or equal to 6.');
        }
    ...
    public function setLanguage($language)
    {
        ...
        if ((mb_strlen($language) > 2)) {
            throw new \InvalidArgumentException('invalid length for $language when calling APIBILLINGDOCUMENTSRVABillingDocumentItemTextType., must be smaller than or equal to 2.');
        }
    ...
    public function setLongTextId($long_text_id)
    {
        ...
        if ((mb_strlen($long_text_id) > 4)) {
            throw new \InvalidArgumentException('invalid length for $long_text_id when calling APIBILLINGDOCUMENTSRVABillingDocumentItemTextType., must be smaller than or equal to 4.');
        }
